...
main(int argc, char **argv)
{
  ...
  2c:	204080e7          	jalr	516(ra) # 22c <atoi>
  ...
  56:	60e080e7          	jalr	1550(ra) # 660 <fprintf>
    exit(1);
  5a:	4505                	li	a0,1
...
strncmp(const char *p, const char *q, uint n)
{
  ...
  while(n > 0 && *p && *p == *q)
  cc:	ce11                	beqz	a2,e8 <strncmp+0x22>
  ce:	00054783          	lbu	a5,0(a0)
  d2:	cf89                	beqz	a5,ec <strncmp+0x26>
  d4:	0005c703          	lbu	a4,0(a1)
  d8:	00f71a63          	bne	a4,a5,ec <strncmp+0x26>
    n--, p++, q++;
  dc:	367d                	addiw	a2,a2,-1
  de:	0505                	addi	a0,a0,1
  e0:	0585                	addi	a1,a1,1
  while(n > 0 && *p && *p == *q)
  e2:	f675                	bnez	a2,ce <strncmp+0x8>
  if(n == 0)
    return 0;
  e4:	4501                	li	a0,0
  e6:	a809                	j	f8 <strncmp+0x32>
  e8:	4501                	li	a0,0
  ea:	a039                	j	f8 <strncmp+0x32>
  if(n == 0)
  ec:	ca09                	beqz	a2,fe <strncmp+0x38>
  return (uchar)*p - (uchar)*q;
  ee:	00054503          	lbu	a0,0(a0)
  f2:	0005c783          	lbu	a5,0(a1)
  f6:	9d1d                	subw	a0,a0,a5
}
  f8:	6422                	ld	s0,8(sp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40e:	49e50513          	addi	a0,a0,1182 # 8a8 <digits>
 412:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 512:	34270713          	addi	a4,a4,834 # 850 <malloc+0x10a>
 ...
 59c:	310b8b93          	addi	s7,s7,784 # 8a8 <digits>
 ...
 5f0:	25c90913          	addi	s2,s2,604 # 848 <malloc+0x102>
        while(*s != 0){
